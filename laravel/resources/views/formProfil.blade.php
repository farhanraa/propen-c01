              ...
              <div class="col-md-12 col-sm-12 mb">
                  ...
                  <div class="dahboard-menu"> 
                          ...
                          <div>
                            <h4><b>Profil Karyawan</b></h4>
                             <table id="tabelProfil"  style="width: 100%;">
                              ...
                              <button class="btn btn-primary btn-lg" type="submit" style="margin-top:20px; margin-left: 490px;">Ubah</a>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="form-field" style="padding-left:15px; padding-right:15px; padding-top:15px; padding-bottom:15px;">
                     ...
                     <form class="form-field"  action="{{ route('tambahPB') }}" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form tambah pengalaman berorganisasi</h4>
                      <div class="col-lg-6">
                    ...
                    <form class="form-field"  action="{{ route('tambahHDP') }}" method="post" enctype="multipart/form-data">
                       <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form tambah hobi & prestasi</h4>
                      <div class="col-lg-6">
                    ...
                    <div class="form-field" style="padding-left:15px; padding-right:15px; padding-top:15px; padding-bottom:15px;">
                       ...
                       <form class="form-field"  action="{{ route('tambahKP') }}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form tambah kontrak/percobaan</h4>
                      <div class="col-lg-6">
                    ...
                    <div class="form-field" style="padding-left:15px; padding-right:15px; padding-top:15px; padding-bottom:15px;">
                          ...
                          <div class="content">
                          <br>
                       <form class="form-field"  action="{{ route('tambahPD') }}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form tambah pendidikan</h4>
                      <div class="col-lg-4">
                         <label for="reason"><strong>Jenjang</strong></label> 
                       <input class="form-control" type="Text" value="" name="tingkat_pendidikan" required>
                      </div>
                        <div class="col-lg-4">
                            <label for="reason"><strong>Institusi Pendidikan</strong></label> 
                            <input class="form-control" type="Text" value="" name="nama_sekolah" required>
                        </div> 
                        <div class="col-lg-4">
                            <label for="reason"><strong>Jurusan</strong></label> 
                            <input class="form-control"  type="Text" value="" name="jurusan" required>
                        </div> 
                        <div class="col-lg-4">
                            <label for="reason"><strong>Tahun Masuk</strong></label> 
                            <input class="form-control"  type="number" value="" name="tahun_masuk" required>
                        </div> 
                        <div class="col-lg-4">
                            <label for="reason"><strong>Tahun Lulus</strong></label> 
                            <input class="form-control" type="number" value="" name="tahun_lulus" required>
                        </div> 
                        <div class="col-lg-4">
                            <label for="reason"><strong>IPK/Nilai Akhir</strong></label> 
                            <input class="form-control" type="Text" value="" name="ipk" required>
                        </div> 
                        <div>
                            <label for="reason" style="padding-left: 15px;"><strong>Catatan</strong></label> 
                            <input class="form-control" type="Text" value="" name="catatan" required>
                        </div> 
                          <button class="btn btn-primary" type="submit"  style="margin-top:14px; margin-left: 14px">Tambah</button>
                    </form>  
                      </div>
                    ...
                    <form class="form-field"  action="{{ route('tambahSP') }}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form tambah sertifikasi & pelatihan</h4>
                      <div class="col-lg-6">
                    ...
                    <div class="form-field" style="padding-left:15px; padding-right:15px; padding-top:15px; padding-bottom:15px;">
                       ...
                       <form class="form-field"  action="{{ route('tambahBA') }}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form tambah kemampuan bahasa</h4>
                      <div class="col-lg-4">
                    ...
                    <div class="form-field" style="padding-left:15px; padding-right:15px; padding-top:15px; padding-bottom:15px;">
                     ...
                     <form class="form-field"  action="{{ route('tambahPK') }}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form tambah pengalaman kerja</h4>
                      <div class="col-lg-6">
                    ...
                    <div class="form-field" style="padding-left:15px; padding-right:15px; padding-top:15px; padding-bottom:15px;">
                     ...
                     <form class="form-field"  action="{{ route('tambahK1') }}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form tambah keluarga sebagai orang tua</h4>
                      <div class="col-lg-4">
                ...
                <option value="P">Perempuan</option>
                     ...
                     <form class="form-field"  action="{{ route('tambahK2') }}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form Tambah Keluarga sebagai anak</h4>
                        <div class="col-lg-4">
                         <label for="reason"><strong>Hubungan</strong></label> 
                       <input class="form-control" type="Text" value="" name="hubungan" required>
                      </div>
                ...
                <option value="P">Perempuan</option>
                    ...
                    <div class="form-field" style="padding-left:15px; padding-right:15px; padding-top:15px; padding-bottom:30px;">
                    ...
                    <form class="form-field"  action="{{ route('tambahIK') }}" method="post" enctype="multipart/form-data">
                       <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <h4>Form Tambah Informasi Kedisiplinan</h4>
                      <div class="col-lg-4">
                         <label for="reason"><strong>Jenis</strong></label> 
                       <input class="form-control" type="Text" value="" name="jenis" required>
                      </div>
                    ...
                    <a class="btn btn-primary btn-lg" type="submit" href="{{ route('selesai') }}" style="margin-top:20px; margin-left: 490px;">Ajukan</a> 
                    </div>
                </div>
                                              <script>
